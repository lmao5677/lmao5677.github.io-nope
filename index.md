<!DOCTYPE html>
<!-- saved from url=(0044)https://kingofkfcjamal.github.io/CaseClicker -->
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
   
    <title>CaseClicker</title>
    <meta name="mobile-web-app-capable" content="yes">
    <meta name="apple-mobile-web-app-capable" content="yes">
    <link href="./CaseClicker_files/css" rel="stylesheet" type="text/css">
    <link href="./CaseClicker_files/css(1)" rel="stylesheet" type="text/css">
    <link rel="stylesheet" href="./CaseClicker_files/font-awesome.min.css">
    <link rel="stylesheet" href="./CaseClicker_files/stylesheet.css" media="screen" title="no title" charset="utf-8">
	<script src="./CaseClicker_files/jquery.min.js.download"></script>
	<script>
</script>
  </head>
  <body>
    <div class="container noselect">
      ...
      <div class="settingsList hidden">
        ...
        <li>Disable Popup: <input type="checkbox" id="popupCheckbox"></li>
			<div class="audio">
				<div class="sg">
					&nbsp;&nbsp;<audio id="startgame" src="sounds/start-game.mp3" type="audio/mp3"></audio><input type="image" src="./CaseClicker_files/DerV5hu.png" onclick="audiosg();"><input type="image" src="./CaseClicker_files/jHVbUvE.png" onclick="audiosgup();" value="Volume Max"><input type="image" src="./CaseClicker_files/SwyIqRg.png" onclick="audiosgdown();" value="Volume Lowered"><input type="image" src="./CaseClicker_files/tViMF8c.png" onclick="audiosgmute();" value="Volume Mute"><b><font size="56" style="color:white;">You lost</font></b><br>
				</div>
				<div class="be">
					&nbsp;&nbsp;<audio id="botentered" src="sounds/new-item.mp3" type="audio/mp3"></audio><input type="image" src="./CaseClicker_files/DerV5hu.png" onclick="audiobe();"><input type="image" src="./CaseClicker_files/jHVbUvE.png" onclick="audiobeup();" value="Volume Max"><input type="image" src="./CaseClicker_files/SwyIqRg.png" onclick="audiobedown();" value="Volume Lowered"><input type="image" src="./CaseClicker_files/tViMF8c.png" onclick="audiobemute();" value="Volume Mute"><b><font size="56" style="color:white;">Bot joins</font></b><br>
				</div>
				<div class="won">
					&nbsp;&nbsp;<audio id="youwon" src="sounds/win-pot.mp3" type="audio/mp3"></audio><input type="image" src="./CaseClicker_files/DerV5hu.png" onclick="audiowon();"><input type="image" src="./CaseClicker_files/jHVbUvE.png" onclick="audiowonup();" value="Volume Max"><input type="image" src="./CaseClicker_files/SwyIqRg.png" onclick="audiowondown();" value="Volume Lowered"><input type="image" src="./CaseClicker_files/tViMF8c.png" onclick="audiowonmute();" value="Volume Mute"><b><font size="56" style="color:white;">You won</font></b><br>
				</div>
				<div class="a">
					&nbsp;&nbsp;<audio id="accepted" src="sounds/click.wav" type="audio/wav"></audio><input type="image" src="./CaseClicker_files/DerV5hu.png" onclick="audioa();"><input type="image" src="./CaseClicker_files/jHVbUvE.png" onclick="audioaup();" value="Volume Max"><input type="image" src="./CaseClicker_files/SwyIqRg.png" onclick="audioadown();" value="Volume Lowered"><input type="image" src="./CaseClicker_files/tViMF8c.png" onclick="audioamute();" value="Volume Mute"><b><font size="56" style="color:white;">Accepted</font></b><br>
				</div>
				<div class="mc">
					&nbsp;&nbsp;<audio id="menu" src="sounds/menuclick.wav" type="audio/wav"></audio><input type="image" src="./CaseClicker_files/DerV5hu.png" onclick="audiomc();"><input type="image" src="./CaseClicker_files/jHVbUvE.png" onclick="audiomcup();" value="Volume Max"><input type="image" src="./CaseClicker_files/SwyIqRg.png" onclick="audiomcdown();" value="Volume Lowered"><input type="image" src="./CaseClicker_files/tViMF8c.png" onclick="audiomcmute();" value="Volume Mute"><b><font size="56" style="color:white;">Menu</font></b><br>
				</div>
				<div class="ub">
					&nbsp;&nbsp;<audio id="unbox" src="sounds/itemreveal.mp3" type="audio/mp3"></audio><input type="image" src="./CaseClicker_files/DerV5hu.png" onclick="audioub();"><input type="image" src="./CaseClicker_files/jHVbUvE.png" onclick="audioubup();" value="Volume Max"><input type="image" src="./CaseClicker_files/SwyIqRg.png" onclick="audioubdown();" value="Volume Lowered"><input type="image" src="./CaseClicker_files/tViMF8c.png" onclick="audioubmute();" value="Volume Mute"><b><font size="56" style="color:white;">Unbox</font></b><br>
				</div>
			</div>
      ...
      <div class="aboutContainer">
        <div class="aboutInfo">
          <div class="aboutHeader">Welcome to CaseClickerDeluexe.</div>
          <div class="aboutBody">CaseClickerDeluexe is the Deluexe version of CaseClicker, also the standard one too.</div>
          <div class="aboutDevelopers">
            <div class="aboutDev">
              <a class="aboutDevName" href="google.com">Google</a>
              <div class="aboutDevDesc">WITHOUT GOOGLE CHROME WE WOULD NOT BE ABLE TO COPY AND PASTE GRRRRRR.</div>
            </div>
            <div class="aboutDev">
			  <a class="aboutDevName" href="roblox.com">ROBLOX</a>
              <div class="aboutDevDesc">For powering imagination and hashtags.</div>
            </div>
			<div class="aboutDev">
			  <a class="aboutDevName" href="https://steamcommunity.com/id/KingofKFC">King of KFC Jamal</a>
              <div class="aboutDevDesc">HE MADE THE SICK MAN TING!!!.</div>
            </div>
          </div>
      ...
      <div class="main">
        ...
        <div class="left">
          <div class="display" style="width: 583px;">
            <div class="jackpot">
            ...
            <div class="unboxing">
              ...
              <div class="caseDisplay" id="case">
                <img src="./CaseClicker_files/240fx182f" id="caseDisplayImage">
                <div class="caseInfoContainer">
                  <div class="caseName" id="caseName">Weapon Case 1</div>
                  <div class="priceContainer">
                    <div class="casePrice" id="casePrice">Case Price: $6.90  |</div>
                    <div class="keyPrice" id="keyPrice">Key Price: $2.50</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="right">
          <div class="mainInfo">
            <div class="mainInfoLabel wallet">Wallet: <span class="money" id="money">$7.50</span></div>
            <div class="mainInfoLabel inv" id="invSpace">Inventory Space: <span class="inventorySpace" id="inventorySpace">0/50</span> <div class="mainInfoLabelWarning tt" data-tt="Inventory over max capacity."><i class="fa fa-exclamation-triangle"></i></div></div>
          </div>
          <div class="tabContainer">
            <div class="tab active" id="inventoryTab">Inventory</div>
            <div class="tab" id="upgradeTab">Your Local Tesco</div>
            <div class="tab" id="caseTab">Case</div>
            <div class="tab" id="jackpotTab">Jackpot</div>
			<div class="tab" id="coinTab">Super Coin Flip</div>
          </div>
          <div class="rightMain">
            ...
            <div class="upgradeContainer">
              ...
              <div class="upgrade" id="upgrade1"> <div class="upgradePicture"> <img src="./CaseClicker_files/100fx100f" id="upgradePicture"></div> <div class="upgradeInfo"> <div class="upgradeName">Inventory Space</div> <div class="upgradeDesc">+1 to your max inventory space.</div> <div class="upgradePriceLabel">Price: <span class="upgradePrice">$15.00</span> </div> <div class="upgradeAmountLabel">Amount: <span class="upgradeAmount">0</span> </div> </div> </div><div class="upgrade" id="upgrade2"> <div class="upgradePicture"> <img src="./CaseClicker_files/100fx100f(1)" id="upgradePicture"></div> <div class="upgradeInfo"> <div class="upgradeName">Key Discount</div> <div class="upgradeDesc">Discount Key Prices</div> <div class="upgradePriceLabel">Price: <span class="upgradePrice">$150.00</span> </div> <div class="upgradeAmountLabel">Amount: <span class="upgradeAmount">0</span> </div> </div> </div><div class="upgrade" id="upgrade3"> <div class="upgradePicture"> <img src="./CaseClicker_files/100fx100f" id="upgradePicture"></div> <div class="upgradeInfo"> <div class="upgradeName">More Money</div> <div class="upgradeDesc">More money per click +10</div> <div class="upgradePriceLabel">Price: <span class="upgradePrice">$500.00</span> </div> <div class="upgradeAmountLabel">Amount: <span class="upgradeAmount">0</span> </div> </div> </div></div>
			...
			<div class="coinContainer"><br><br><br>
			<center><button onclick="myFunction()"><img src="./CaseClicker_files/Ga7WRKc.png"></button></center>
			</div>
    ...
    <script src="./CaseClicker_files/script.js.download" type="text/javascript"></script>
